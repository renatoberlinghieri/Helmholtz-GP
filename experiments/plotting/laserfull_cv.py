...
def load_data(directory: Path) -> Dict:
    ...
    """
    load_path = str(Path(directory, f"laserfull.json"))
...
def load_results(results_dir: Path) -> Dict:
    ...
    load_paths = [
        str(Path(results_dir, "laserfull", f"{method}.json")) for method in methods
    ]
...
if __name__ == "__main__":
    ...
    plt.tight_layout()
    plt.savefig("./experiments/plotting/laserfull_cv.png")
    plt.show()
